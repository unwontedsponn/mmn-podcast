...
export default function About({ setAboutInView }: AboutProps) {
  ...
  return (
    <FadeIn className="flex min-h-screen">
      ...
      <div className="lg:w-1/2 flex flex-col justify-center p-12 space-y-6 lg:pr-40">
        ...
        <button className="text-center border-2 border-red text-white bg-red lg:text-red lg:bg-snow hover:bg-red hover:text-white text-xl py-2 px-4 w-40 text-left">
          Watch video
